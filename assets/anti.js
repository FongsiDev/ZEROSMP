...
function disableEnterKey(e) {
  ...
  if (e.ctrlKey) {
    ...
    if (
      ...
      show_msg_warting("You are not allowed to copy content or view source");
      return false;
    } else return true;
  }
}
...
function disable_copy(e) {
  ...
  if (elemtype == "IMG" && checker_IMG == "checked" && e.detail >= 2) {
    show_msg_warting(alertMsg_IMG);
    return false;
  }
  if (elemtype != "TEXT") {
    if (smessage !== "" && e.detail == 2) show_msg_warting(smessage);
